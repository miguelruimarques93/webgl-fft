...
// Source: definitions/webgl2.gen.d.ts
...
interface WebGLTransformFeedback extends WebGLObject {
  __WebGLTransformFeedback: void;
}

interface WebGLVertexArrayObject extends WebGLObject {
  __WebGLVertexArrayObject: void;
}
...
interface WebGL2RenderingContext extends WebGLRenderingContext {
  ...
  texSubImage3D(target: number, level: number, xoffset: number, yoffset: number, zoffset: number, width: number, height: number, depth: number, format: number, type: number, pixels: ArrayBufferView): void;
  texSubImage3D(target: number, level: number, xoffset: number, yoffset: number, zoffset: number, format: number, type: number, source: (HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | ImageData)): void;
  ...
  compressedTexSubImage3D(target: number, level: number, xoffset: number, yoffset: number, zoffset: number, width: number, height: number, depth: number, format: number, data: ArrayBufferView): void;
  ...
  uniform1uiv(location: WebGLUniformLocation, value: (Uint32Array | number[])): void;
  uniform2uiv(location: WebGLUniformLocation, value: (Uint32Array | number[])): void;
  uniform3uiv(location: WebGLUniformLocation, value: (Uint32Array | number[])): void;
  uniform4uiv(location: WebGLUniformLocation, value: (Uint32Array | number[])): void;
  uniformMatrix2x3fv(location: WebGLUniformLocation, transpose: boolean, value: (Float32Array | number[])): void;
  uniformMatrix3x2fv(location: WebGLUniformLocation, transpose: boolean, value: (Float32Array | number[])): void;
  uniformMatrix2x4fv(location: WebGLUniformLocation, transpose: boolean, value: (Float32Array | number[])): void;
  uniformMatrix4x2fv(location: WebGLUniformLocation, transpose: boolean, value: (Float32Array | number[])): void;
  uniformMatrix3x4fv(location: WebGLUniformLocation, transpose: boolean, value: (Float32Array | number[])): void;
  uniformMatrix4x3fv(location: WebGLUniformLocation, transpose: boolean, value: (Float32Array | number[])): void;
  ...
  clearBufferiv(buffer: number, drawbuffer: number, value: (Int32Array | number[])): void;
  clearBufferuiv(buffer: number, drawbuffer: number, value: (Uint32Array | number[])): void;
  clearBufferfv(buffer: number, drawbuffer: number, value: (Float32Array | number[])): void;
